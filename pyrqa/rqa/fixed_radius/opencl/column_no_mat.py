...
"""
RQA, Fixed Radius, OpenCL, ColumnNoMat
"""
...
class ColumnNoMat(RQASubMatricesCarryover, AbstractRunnable):
    """
    ...
    def process_sub_matrix(self, *args, **kwargs):
        ...
        while True:
            try:
                ...
                # Vertical kernel
                vertical_args = [time_series_x_buffer,
                                 time_series_y_buffer,
                ...
                if self.settings.is_matrix_symmetric:
                    diagonal_args = [time_series_x_buffer,
                                     time_series_y_buffer,
                                     np.uint32(sub_matrix.dim_x),
                                     np.uint32(sub_matrix.dim_y),
                ...
                diagonal_events.append(cl.enqueue_nd_range_kernel(command_queue, diagonal_kernel, global_work_size, local_work_size))
