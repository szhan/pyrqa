...
"""
RQA, Fixed Radius, OpenCL, ColumnMatByteRec
"""
...
class ColumnMatByteRec(RQASubMatricesCarryover, AbstractRunnable):
    """
    ...
    def process_sub_matrix(self, *args, **kwargs):
        ...
        while True:
            try:
                ...
                vertical_events.append(cl.enqueue_nd_range_kernel(command_queue, vertical_kernel,
                                                                  global_work_size,
                                                                  local_work_size))
